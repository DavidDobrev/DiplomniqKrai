...
namespace BusStationTickets.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrederDetailId,ProductId,OrderId,Quality,Price")] OrderDetails orderDetails)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "Description", orderDetails.ProductId);
            return View(orderDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrederDetailId,ProductId,OrderId,Quality,Price")] OrderDetails orderDetails)
        {
